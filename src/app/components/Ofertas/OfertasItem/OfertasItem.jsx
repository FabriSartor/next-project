...
export default function OfertasItem ({ofertas}) {
    return (
        <div className="flex h-[240px] justify-between gap-3">
            {
                ofertas.map(item =>{ 
                    return (
                        <Link href={item.link} className=" flex flex-row bg-white rounded-md overflow-hidden h-[100%] w-full hover:shadow-lg hover:shadow-gray-400 duration-200">
